this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
    ...
    Sa.innerHTML = '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n    display: flex;\n    justify-content: space-between;\n    align-items: flex-end;\n  }\n\n  #privacy-policy,\n  #copyright {\n    text-align: left;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Challenge Mode</div>\n          <div class="description">Any revealed hints must be used in subsequent guesses</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Dark Theme</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Color Blind Mode</div>\n          <div class="description">High contrast colors</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n<section> <div class ="setting" > \n <div class = "text" > \n <div class = "title" > Support Project </div>\n </div > \n <div class = "control" > \n <a href = "https://sales.aviparshan.com/p/referral-links-and-cashback-sites.html?utm_source=avisite" title = "Deals and Discounts" target="_blank"> Get Merch </a>\n </div>\n </div>\n </section>\n\n   <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Feedback</div> \n </div>\n        <div class="control">\n          <a href="https://www.facebook.com/wordlefan" title="FB Page" target=" _blank">Message Us</a>\n  |\n       <a href="https://twitter.com/intent/tweet?screen_name=aviinfnity" target="_blank" title="@aviinfinity">Twitter</a>\n        </div>\n      </div>\n    </section>\n  </div>\n  <div id="footnote">\n    <div>\n      <div id="privacy-policy"><a href="https://unitmeasure.xyz/privacy.html?utm_source=wurdle" target="_blank">Privacy Policy</a></div>\n      <div id="copyright">Copyleft 2022. No Rights Reserved. https://github.com/avipars/WordleOSS</div>\n    </div>\n    <div>\n      <div id="puzzle-number"></div>\n      <div id="hash"></div>\n    </div>\n  </div>\n';
    var _a = function(e) {
        r(t, e);
        var a = h(t);
    ...
    var Ba = "abcdefghijklmnopqrstuvwxyz", //alphabet
                        ...
                        p.appendChild(m), this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function(a) {
                            ...
                            As(function(e) {
                                var a = e.evaluations,
                                    ...
                                    l = "Wurdle https://avipars.github.io/WordleOSS/?utm_source=share \n".concat(s); //title
